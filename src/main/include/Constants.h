...
namespace OperatorConstants
{
    ...
    constexpr int kJoystickDriverControllerPort = 2;
...
;
    ...
    /* Rear Left Module */
    constexpr double RL_DEGREE_OFFSET = 1.286637 ;
;
...
//cube positions
  constexpr double Hight = 190;
  constexpr double Mid = 172;
  constexpr double Low = 140;
  constexpr double Default = 210;
  constexpr double kParm = 0.015;
  constexpr double kIarm = 0.0000002;
  constexpr double kDarm = 0.00000005;
}

namespace IntakeConstants {
  
  //Intake launch levels
  constexpr double low_SpitSpeedConstant = 0.1;
  constexpr double mid_SpitSpeedConstant = 0.5;
  constexpr double high_SpitSpeedConstant = 0.9;

  //Default catcssh speed
  constexpr double default_CatchSpeedConstant = -0.2;
}

namespace ShooterConstants {
  constexpr double speaker_ShootSpeedConstant = 1.0;//Velocidade do motor do Shooter para lançar no Speaker
  constexpr double amplifier_ShootSpeedConstant = 0.2;//Velocidade do motor do Shooter para lançar no Amplificador
}