...
class IntakeSubsystem : public frc2::SubsystemBase {
 ...
 private:
  ...
  rev::CANSparkMax intakeLeftMotor{13,rev::CANSparkMax::MotorType::kBrushless};
  rev::CANSparkMax intakeRightMotor{14,rev::CANSparkMax::MotorType::kBrushless};

    

  //Implemating the 2 motors in just one object ->  GroupController class
  frc::MotorControllerGroup motorIntake_Group{intakeLeftMotor, intakeRightMotor};
